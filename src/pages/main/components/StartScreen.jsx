...
const StartScreen = ({isClicked, isBackground, onClick}) => {
	return(
		<div onClick={onClick} className={classNames('main-before-background', {'fade-out': !isBackground})}>
			{isClicked && <div style={{position:'absolute', display:'flex', top:20, right:20}}>
			...
			<div style={{display:'flex', position:'relative', flexDirection:'column', alignItems:'center', color:'rgb(178 103 103)'}}>
				...
				{!isClicked && <div style={{fontSize:30, color:'rgb(141,134,129)'}}>시작하려면 화면을 클릭하세요!</div>}
